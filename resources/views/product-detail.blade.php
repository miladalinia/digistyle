                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="product-list.blade.php" class="nav-item nav-link">Products</a>
                            <a href="product-detail.blade.php" class="nav-item nav-link active">Product Detail</a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="wishlist.blade.php" class="dropdown-item">Wishlist</a>
                                    <a href="login.blade.php" class="dropdown-item">Login & Register</a>
                                    <a href="contact.blade.php" class="dropdown-item">Contact Us</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="bottom-bar">
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="user">
                            <a href="wishlist.blade.php" class="btn wishlist">
                                <i class="fa fa-heart"></i>
                                <span>(0)</span>
                            </a>
                            <a href="cart.blade.php" class="btn cart">
